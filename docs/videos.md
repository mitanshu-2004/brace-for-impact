...
All 40 clips are attached to the
[latest release](https://github.com/mitanshu-2004/brace-for-impact/releases/latest), along with
the trained robots. They are too large to keep in the repository itself, but release
attachments live on GitHub too, so there is nothing to sign up for and nowhere else to go.
